      ...
      <div className="page-container pb-12 -mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
          <div className="relative group">
            ...
            <div className="relative bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-400 mb-1">Total Submissions</p>
                  <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">{stats?.total || 0}</p>
                </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-amber-600 dark:text-amber-400 mb-1">Pending Review</p>
                  <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">{stats?.pending || 0}</p>
                </div>
              ...
              <div className="flex items-center mt-3 sm:mt-4 text-xs sm:text-sm">
                ...
                <span className="text-muted-foreground ml-1 hidden sm:inline">response time</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-purple-600 dark:text-purple-400 mb-1">Under Review</p>
                  <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">{stats?.underReview || 0}</p>
                </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm font-medium text-green-600 dark:text-green-400 mb-1">Resolved</p>
                  <p className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">{stats?.resolved || 0}</p>
                </div>
              ...
              <div className="flex items-center mt-3 sm:mt-4 text-xs sm:text-sm">
                ...
                <span className="text-muted-foreground ml-1 hidden sm:inline">satisfaction rate</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            <Card className="border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
              <CardHeader className="pb-3 sm:pb-4 px-4 sm:px-6">
                <CardTitle className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-200 bg-clip-text text-transparent">
                  Submission Categories
                </CardTitle>
                <p className="text-sm sm:text-base text-muted-foreground">Choose the category that best describes your feedback</p>
              </CardHeader>
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
                          <div className={cn("h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 rounded-xl sm:rounded-2xl flex items-center justify-center text-white shadow-lg", category.color)}>
                            <span className="text-sm sm:text-lg lg:text-xl">📊</span>
                          </div>
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-xs sm:text-sm lg:text-base text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors truncate">
                              {category.name}
                            </h4>
            ...
            {stats && (
              <Card className="border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
                <CardHeader className="px-4 sm:px-6">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground">Visual breakdown of submissions by category</p>
                </CardHeader>
          ...
          <div className="space-y-6 sm:space-y-8">
            <Card className="border-0 shadow-xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
              <CardHeader className="px-4 sm:px-6">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">Start making a difference today</p>
              </CardHeader>
              <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                <Link href="/submit">
                  <Button 
                    className="w-full justify-start h-12 sm:h-14 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl px-3 sm:px-4" 
                    data-testid="quick-action-submit"
                  >
                    <Plus className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0" />
                    <div className="text-left min-w-0">
                      <div className="font-semibold text-sm sm:text-base">Submit New Complaint</div>
                      <div className="text-xs text-blue-100 hidden sm:block">Anonymous and secure</div>
                    </div>
                  </Button>
                </Link>
                <Link href="/suggestions">
                  <Button 
                    className="w-full justify-start h-12 sm:h-14 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl px-3 sm:px-4" 
                    data-testid="quick-action-suggest"
                  >
                    <Lightbulb className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 flex-shrink-0" />
                    <div className="text-left min-w-0">
                      <div className="font-semibold text-sm sm:text-base">Share Suggestion</div>
                      <div className="text-xs text-green-100 hidden sm:block">Help improve campus life</div>
                    </div>
                  </Button>
                </Link>
                <Link href="/track">
